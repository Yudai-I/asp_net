            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="最終更新日" SortExpression="updated">
                    <EditItemTemplate>
                        ...
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtUpdated" CssClass="valid" ErrorMessage="最終更新日は日付形式で入力してください" Operator="DataTypeCheck" Type="Date">*</asp:CompareValidator>
                    </EditItemTemplate>
                    <ItemTemplate>
